...
public sealed class SendConfirmEmailDomainEvent(IFluentEmail fluentEmail) : INotificationHandler<AuthDomainEvent>
{
...
public sealed class SendSmsDomainEvent : INotificationHandler<AuthDomainEvent>
{
    public async Task Handle(AuthDomainEvent notification, CancellationToken cancellationToken)
    {
        Console.WriteLine("Sms gönderme işlemi başarıyla sonuçlandı");
